...
#write file_type filename [beg nb] [end ne ] [skip ns] [waitfor nw] [sel selection] [molecule_number]
 ...
 set num_steps [expr ($num_steps + 1)]
        ...
        set outDataFile [open dev1-CD-rmsd.dat w]

                set reference [atomselect top  "segid PROA and resid 1 to 166 and backbone" frame 0]
                set compare [atomselect top  "segid PROA and resid 1 to 166 and backbone"]
